...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<div id="volver"><a href="javascript:history.go(-1);"><img src="<cms:link>/system/modules/es.uva.web.portal.opencms.v85.tipos.noticias/resources/images/back.png</cms:link>" border="0" align="absmiddle" alt="volver"/> volver</a></div>
